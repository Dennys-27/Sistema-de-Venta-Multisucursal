...
$(document).on("click", "#btnnuevo", function () {
  ...
  $("#pre_imagen").html(
    '<img src="../../assets/usuarios/user.png" class="rounded-circle avatar-xl img-thumbnail user-profile-image" alt="user-profile-image"></img><input type="hidden" name="hidden_usuario_imagen" value="" />'
  );
