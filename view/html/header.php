                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            if ($_SESSION["USU_IMG"] == "") {
                            ?>
                                <img class="rounded-circle header-profile-user" src="../../assets/usuarios/user.png" alt="Header Avatar">
                            <?php
                            } else {
                            ?>
                                <img class="rounded-circle header-profile-user" src="../../assets/usuarios/<?php echo $_SESSION["USU_IMG"] ?>" alt="Header Avatar">
                            <?php
                            }
                            ?>
                    ...
                    <!-- AGREGAR VARIABLE DE SESSION OCULTA -->
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="../MntPerfil/"><i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Perfil</span></a>
                        ...
                        <a class="dropdown-item" href="../html/logout.php"><i class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i> <span class="align-middle" data-key="t-logout">Cerrar Sesión</span></a>
                    </div>
                </div>
            </div>
        </div>
