            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <?php
                    foreach ($datos as $row) {
                       if ($row["MEN_GRUPO"]=="Dashboard" && $row["MEND_PERMISO"]=="Si"){
                            ?>
                                <li class="nav-item">
                ...
                <?php
                    foreach ($datos as $row) {
                       if ($row["MEN_GRUPO"]=="Mantenimiento" && $row["MEND_PERMISO"]=="Si"){
                            ?>
                                <li class="nav-item">
                                    <a class="nav-link menu-link" href="<?php echo $row["MEN_RUTA"];?>">
                                        <i class="ri-honour-line"></i> <span data-key="t-widgets"><?php echo $row["MEN_NOM"];?></span>
                ...
                <?php
                    foreach ($datos as $row) {
                       if ($row["MEN_GRUPO"]=="Compra" && $row["MEND_PERMISO"]=="Si"){
                            ?>
                                <li class="nav-item">
                                    <a class="nav-link menu-link" href="<?php echo $row["MEN_RUTA"];?>">
                                        <i class="ri-honour-line"></i> <span data-key="t-widgets"><?php echo $row["MEN_NOM"];?></span>
                ...
                <?php
                    foreach ($datos as $row) {
                       if ($row["MEN_GRUPO"]=="Venta" && $row["MEND_PERMISO"]=="Si"){
                            ?>
                                <li class="nav-item">
                                    <a class="nav-link menu-link" href="<?php echo $row["MEN_RUTA"];?>">
                                        <i class="ri-honour-line"></i> <span data-key="t-widgets"><?php echo $row["MEN_NOM"];?></span>
