...
switch ($_GET["op"]) {
    ...
    case "listardetalle":
        ...
        foreach ($datos as $row) {
            ...
            $sub_array[] = '<button type="button" onClick="eliminar(' . $row["DETV_ID"] . ',' . $row["VENT_ID"] . ')" id="' . $row["DETV_ID"] . ',' . $row["VENT_ID"] . '" class="btn btn-danger btn-icon waves-effect waves-light"><i class="ri-delete-bin-5-line"></i></button>';
            $data[] = $sub_array;
        }
...
?>
    ...
    case "listarventa":
        ...
        foreach ($datos as $row) {
            ...
            $sub_array[] = '<button type="button" onClick="ver(' . $row["VENT_ID"] . ')" id="' . $row["VENT_ID"] . '" class="btn btn-success btn-icon waves-effect waves-light"><i class=" ri-eye-fill"></i></button>';
            $data[] = $sub_array;
        }
